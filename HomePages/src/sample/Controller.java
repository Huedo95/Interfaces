...
public class Controller  implements Initializable{
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        pane1.setStyle("-fx-background-image: url('sample/img1.jpeg')");
        pane2.setStyle("-fx-background-image: url('sample/img2.jpg')");
        pane3.setStyle("-fx-background-image: url('sample/img3.jpg')");
        pane4.setStyle("-fx-background-image: url('sample/img4.jpg')");
